...
-Milk-V Duo SDK is needed to compile your C / C++ programs, please check this website: https://github.com/milkv-duo/duo-buildroot-sdk

-A lot of time and disk spaces will be consumed if you really want to compile this program.. (simply download the executable file is suggested)
